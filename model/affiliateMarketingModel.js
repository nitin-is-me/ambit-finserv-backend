...
const AffiliateMarketingSchema = new Schema(
  {
    uniqueID: {
      type: String,
      unique: true,
    ...
    Electricity_Bill_Home: String,
    Electricity_Bill_Office: String,
    dl_number: String,
    pin_code: String,
    city_name: String,
    state_name: String,
...
const AffiliateMarketing = mongoose.model(
  'affiliateMarketing',
  AffiliateMarketingSchema,
);

module.exports = AffiliateMarketing;
